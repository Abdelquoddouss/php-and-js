        ...
        <div class="row ">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
                ...
                <div class="categories col-lg-9">
                    ...
                    <div class="more">
                        <p>browse more</p>
                        <img src="../assets/img/next.png" alt="" srcset="">
                    </div>
                </div>
                
                <?php for($i = 1; $i <= count($results) / 3; $i++) : ?>
                    <div class="cards-products">
                        <?php for ($j = ($i * 3) - 3; $j < $i * 3; $j++) : ?>
                        <div class="card-product">
                            <div class="image-product">
                                <img src="<?php echo $results[$j][3] ?>" alt="">
                            </div>
                            <div class="description">
                                <h6><?php echo $results[$j][1] ?></h6>
                                <span>$ <?php echo $results[$j][2] ?></span>
                                <div class="stars-icons">
                                    <img src="../assets/img/star-co.png" alt="" srcset="">
                                    <img src="../assets/img/star-co.png" alt="" srcset="">
                                    <img src="../assets/img/star-co.png" alt="" srcset="">
                                    <img src="../assets/img/star-co.png" alt="" srcset="">
                                    <img src="../assets/img/star.png" alt="" srcset="">
